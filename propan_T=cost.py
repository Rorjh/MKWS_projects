# -*- coding: utf-8 -*-
"""
Created on Sun Apr  7 13:49:16 2019
...
T=2500 #stala temperatura poczatkowa
...
#plt.yscale('log')
plt.title('Ignition delay of propane-air mixture', fontweight='bold')
plt.grid()
plt.savefig('propane_tau(p).png', dpi=1000)
plt.show()